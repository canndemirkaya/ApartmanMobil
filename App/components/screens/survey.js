    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.mainContent}>
          ...
          <Text style={styles.mainContentHeaderText}>Anket Alanı</Text>
          ...
          <View style={styles.residentListView}>
            ...
            renderItem={(item) => {
              return(
                <TouchableOpacity onPress={() => {
                  this.props.navigation.navigate('SurveyOne', {SurveyID:item.item.id, ApartmanName:this.state.ApartmanName});
                }}>
                  <View style={styles.residentList}>
                    <View style={styles.residentListItem}>
                        <Text style={styles.residentListText}>{item.item.SurveyHeader}</Text>
                    </View>
                    <View style={styles.residentListItem}>
                        <Text style={styles.residentListTextRight}></Text>
                    </View>
